...
Diupdate: ${server.updated_at}`)
       ...
       //     if (!isROwner) return global.dfail("rowner", m, conn)
            let t = text.split(",");
            if (t.length < 2) return m.reply(`
> Perintah :\n${_p + command} nomor,namaserver`);
            let nomor = t[0]
            if (userz.saldo < harga1gb) {
              m.reply('Saldo User Anda Kurang!. Silahkan Melakukan Deposit Terlebih Dahulu')
              } else if(userz.saldo > harga1gb) {
			let name = t[1];
			let memo = '1024'
			let egg = eggs
			let loc = locs
			...
			let cpu = '40'
      global.db.data.users[who].saldo -= harga1gb
...
> Perintah :\n${_p + command} nomor,namaserver`);
            let nomor = t[0]
            if (userz.saldo < harga2gb) {
              m.reply('Saldo User Anda Kurang!. Silahkan Melakukan Deposit Terlebih Dahulu')
              } else if(userz.saldo > harga2gb) {
			...
			let memo_disk = memo.split`/`;
			let cpu = '70'
      global.db.data.users[who].saldo -= harga2gb
...
> Perintah :\n${_p + command} nomor,namaserver`);
            let nomor = t[0]
            if (userz.saldo < harga3gb) {
              m.reply('Saldo User Anda Kurang!. Silahkan Melakukan Deposit Terlebih Dahulu')
              } else if(userz.saldo > harga3gb) {
			...
			let memo_disk = memo.split`/`;
			let cpu = '100'
      global.db.data.users[who].saldo -= harga3gb
...
> Perintah :\n${_p + command} nomor,namaserver`);
            let nomor = t[0]
            if (userz.saldo < harga4gb) {
              m.reply('Saldo User Anda Kurang!. Silahkan Melakukan Deposit Terlebih Dahulu')
              } else if(userz.saldo > harga4gb) {
			...
			let memo_disk = memo.split`/`;
			let cpu = '120'
      global.db.data.users[who].saldo -= harga4gb
...
> Perintah :\n${_p + command} nomor,namaserver`);
            let nomor = t[0]
            if (userz.saldo < harga5gb) {
              m.reply('Saldo User Anda Kurang!. Silahkan Melakukan Deposit Terlebih Dahulu')
              } else if(userz.saldo > harga5gb) {
			...
			let memo_disk = memo.split`/`;
			let cpu = '140'
      global.db.data.users[who].saldo -= harga5gb
...
> Perintah :\n${_p + command} nomor,namaserver`);
            let nomor = t[0]
            if (userz.saldo < harga6gb) {
              m.reply('Saldo User Anda Kurang!. Silahkan Melakukan Deposit Terlebih Dahulu')
              } else if(userz.saldo > harga6gb) {
			...
			let memo_disk = memo.split`/`;
			let cpu = '170'
      global.db.data.users[who].saldo -= harga6gb
...
> Perintah :\n${_p + command} nomor,namaserver`);
            let nomor = t[0]
            if (userz.saldo < harga7gb) {
              m.reply('Saldo User Anda Kurang!. Silahkan Melakukan Deposit Terlebih Dahulu')
              } else if(userz.saldo > harga7gb) {
			...
			let memo_disk = memo.split`/`;
			let cpu = '200'
      global.db.data.users[who].saldo -= harga7gb
...
> Perintah :\n${_p + command} nomor,namaserver`);
            let nomor = t[0]
            if (userz.saldo < hargaunli) {
              m.reply('Saldo User Anda Kurang!. Silahkan Melakukan Deposit Terlebih Dahulu')
              } else if(userz.saldo > hargaunli) {
			...
			let memo_disk = memo.split`/`;
			let cpu = '0'
      global.db.data.users[who].saldo -= hargaunli

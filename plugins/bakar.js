...
let nomors = m.sender
  ...
  m.reply(`Target berhasil di bakar dan kamu mengambil money target sebesar\n${dapat} Money\nDarah target berkurang -${healtu} Healt`)
}else conn.reply(m.chat, `Anda sudah bakar orang dan berhasil sembunyi , tunggu ${timers} untuk bakar lagi`, m)
}

handler.help = ['bakar *@tag*']
handler.tags = ['rpg']
handler.command = /^bakar$/
handler.limit = true
handler.group = true

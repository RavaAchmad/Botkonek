...
let stiker = await createSticker(null, global.API(`https://telegra.ph/file/a32b24ef4c1651dd5e081.jpg`), global.packname, global.author)
...
ptt: false, seconds: 9999999,contextInfo: {
 ...
 mediaUrl: 'https://youtu.be/yUF-Qkz2hnc',
    mediaType: 2, 
    description: 'https://youtu.be/yUF-Qkz2hnc',
    title: "Tunggu Sebentar Stah",
    body: wm,
    thumbnail: await (await fetch(`${global.fotobotnya}`)).buffer(),
    sourceUrl: 'https://youtu.be/yUF-Qkz2hnc'
  }
  } })

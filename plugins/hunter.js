let handler = async (m, { conn, text }) => {
  let monsters = [
    ...
    { area: 14, name: "Fire Elemental" },
    { area: 14, name: "Ice Elemental" },
    { area: 14, name: "Earth Elemental" },
    { area: 15, name: "Phoenix" },
    { area: 15, name: "Yeti" },
    { area: 15, name: "Frost Giant" },
    { area: 16, name: "Orc" },
    { area: 16, name: "Troll" },
    { area: 16, name: "Goblin King" },
    { area: 17, name: "Wyvern" },
    { area: 17, name: "Basilisk" },
    { area: 17, name: "Chimera" },
    { area: 18, name: "Hydra" },
    { area: 18, name: "Kraken" },
    { area: 18, name: "Leviathan" },
    { area: 19, name: "Beholder" },
    { area: 19, name: "Lich" },
    { area: 19, name: "Dracolich" },
    { area: 20, name: "Demon Lord" },
    { area: 20, name: "Archangel" },
    { area: 20, name: "Titan" },
  ]

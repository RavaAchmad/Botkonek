...
//let ini = (await axios.post(`https://api.yanzbotz.my.id/api/ai/characterai?text=${text}&name=Vestia%20Zeta`)).data
    let inis = await fetch(`https://aemt.me/ai/c-ai?prompt=bully%20scaramouche&text=${teks}`)
...
handler.command = handler.help = ['aiscara', 'scara', 'scaramouche'];
handler.tags = ['ai'];

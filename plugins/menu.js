...
*ᴋᴏɴᴇᴋᴏ-ᴍᴅ* ᴀᴅᴀʟᴀʜ ᴘʀᴏɢʀᴀᴍ ʙᴏᴛ ᴡʜᴀᴛꜱᴀᴘᴘ ʏᴀɴɢ ꜱɪᴀᴘ ᴍᴇᴍʙᴀɴᴛᴜ ᴀɴᴅᴀ ᴅᴀʟᴀᴍ ᴍᴇʟᴀᴋᴜᴋᴀɴ ʙᴇʀʙᴀɢᴀɪ ᴛɪɴᴅᴀᴋᴀɴ, ᴍᴇɴᴄᴀʀɪ ᴅᴀᴛᴀ ᴀᴛᴀᴜ ɪɴꜰᴏʀᴍᴀꜱɪ ᴍᴇʟᴀʟᴜɪ ᴡʜᴀᴛꜱᴀᴘᴘ.
...
`.trimStart(),
  ...
  footer: '╰┄┄┄┄┄┄┄┄┄┄┄┄┄〢',
  after: `sɪᴍᴘʟᴇ ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ ʙʏ ᴋᴏɴᴇᴋᴏ-ᴍᴅ
Copyright : @WhatsApp
${wm}
`,
}
...
const zxcoder = [
    ...
    //{ text: "_〥 *E V E N T* 〥_\n⋄ *.bansos* (Memper cepat Durasi menjadi 30 menit!)(rate win 1,5X!)", timeout: 100}
  ];
